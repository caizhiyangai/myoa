...
<div class="container">
    <img id="pic1" src="static/images/img.jpg">
    <div class="row">
        <div class="col-md-offset-3 col-md-6">
            ...
            <form class="form-horizontal" action="login" method="post" id="loginForm">
                ...
                <div class="error">${sessionScope.cu}</div>
                ...
                <div class="form-group">
                    <div class="col-sm-7">
                        <input type="text" name="code" class="form-control"
                               id="code" placeholder="请输入验证码"> <i
                            class="fa fa-user"></i>
                    </div>
                    <div class="col-sm-5">
                        <img src="${pageContext.request.contextPath}/checkCode"
                              id="img1" width="120px" height="50px"> <a href="#" class="fa fa-question-circle"></a>
                    </div>
                </div>
