                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
                                <span class="glyphicon glyphicon-user" aria-hidden="true"></span> ${activeUser.username}
                            </a>
                            <ul class="dropdown-menu dropdown-menu-arrow-right" role="menu">
                                <li><a href="#"><span class="glyphicon glyphicon-edit" ></span> 修改资料</a></li>
                                <li><a href="javascript:;" id="exit"><span class="glyphicon glyphicon-log-out" ></span> 退出登录</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
