		...
		$(function(){
			$("#rpForm").submit(function(){
				...
				if(role_name==""){
					...
					$.get("checkRoleName",{"roleName":role_name},function(result){
						if(result==="no"){
							alert("角色名已存在!");
							flag = false;
						}
			...
			$("#permissionForm").submit(function(){
				var per_name = $("#per_name").val().trim();
				if(per_name===""){
					alert("权限名不能为空!");
					return false;
				}else{
...
<div class="page-content">
    <form class="form-inline" action="saveRoleAndPermissions" id="rpForm" method="post">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<table class="table table-bordered table-striped" width="800px">
						<tr>
							<td>名称</td>
							<td><input class="form-control" id="per_name" name="name" placeholder="名称"></td>
						</tr>					
						<tr>
							<td>类型</td>
							<td>
