...
<head>
    ...
    <script type="text/javascript">
    	function delDeploy(depId,depName){
    		var del = confirm("确定要删除 '"+depName+"' 这个部署流程吗?");
    		if(del){
    			window.location.href = "delDeployment?deploymentId="+depId;
    		}
    	}
    </script>
</head>
                ...
                <table class="table table-striped table-hover">
					...
					<c:forEach var="dep" items="${depList}">
	                    <tr>
	                        ...
	                        <td>
	                        <!-- delDeployment?deploymentId=${dep.id} -->
	                            <a href="javascript:delDeploy('${dep.id}','${dep.name}')" class="btn btn-danger btn-xs"><span class="glyphicon glyphicon-remove"></span> 删除</a>
	                        </td>
	                    </tr>
					</c:forEach>
                    </tbody>
