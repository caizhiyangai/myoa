				                ...
				                <c:forEach var="role" items="${allRoles}">
				                	<tr id="${role.id}">
				                		...
				                		<td>
											...
											<a href="javascript:del('${role.id}','${role.name}')" class="btn btn-danger btn-xs"><span class="glyphicon glyphicon-remove"></span> 删除</a>
				                		</td>
				                	</tr>
				                </c:forEach>
	                    </tbody>
  ...
  <div class="modal-dialog" >
	<div class="modal-content">
		...
		<div class="modal-footer">
			...
			<button class="btn btn-default" data-dismiss="modal" aria-hidden="true" id="close">关闭</button>
		</div>
		</form>
	  </div>
	</div>
...
function del(roleId,role){
	var del = confirm("确定要删除 '"+role+"' 这个角色吗?");
	if(del){
		window.location.href = "delRole?roleId="+roleId;
	}
}
 /* function closePanel() {
	//location = "findRoles";
