...
<div class="page-content">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form action="${pageContext.request.contextPath}/deployProcess" id="form" enctype="multipart/form-data" method="post">
                    ...
                    <div class="row">
                        <div class="col-md-5">
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control" id="fileName" name="fileName" placeholder="" accept=".zip">
                            </div>
